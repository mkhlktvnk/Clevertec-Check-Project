...
public class UserTestObjectArrayArgumentsProvider implements ArgumentsProvider {
    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        return Stream.of(
                Arguments.of((Object) new UserTestObject[]{
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(4L).username("username-4").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(5L).username("username-5").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(6L).username("username-6").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(7L).username("username-7").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(8L).username("username-8").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(9L).username("username-9").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
                ...
                Arguments.of((Object) new UserTestObject[]{
                        UserTestObject.builder().id(10L).username("username-10").contacts(Set.of(
                                ContactTestObject.builder().id(1L).phone("123123").build(),
                                ContactTestObject.builder().id(2L).phone("123123").build(),
                                ContactTestObject.builder().id(3L).phone("123123").build(),
                                ContactTestObject.builder().id(4L).phone("123123").build(),
